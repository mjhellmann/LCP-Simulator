        ...
        if self.radio_button_molar_fraction.selected == True:
            ...
            if self.radio_button_enzyme.selected == True:
                if self.radio_button_FAp.selected == True:
                    filename = "prof_enz_molar_DP%s_FA%s_mol%s_FAp%s_p%s_-%s_+%s_e%s" % (DP, overall_FA,
                    ...
                    filename = "prof_enz_molar_DP%s_FA%s_mol%s_s%s_p%s_-%s_+%s_e%s" % (DP, overall_FA,
                                                                                            molecules, strength,
                                                                                            pattern, minus_specificity,
                                                                                            plus_specificity, efficiency)
                ...
                if self.radio_button_FAp.selected == True:
                    filename = "prof_nano2_molar_DP%s_FA%s_mol%s_FAp%s_p%s_c%s" % (DP, overall_FA,
                                                                                            molecules, FA_pattern,
                                                                                            pattern, cuts)
                    ...
                    filename = "prof_nano2_molar_DP%s_FA%s_mol%s_s%s_p%s_c%s" % (DP, overall_FA,
                                                                                            molecules, strength,
                                                                                            pattern, cuts)
            ...
            if self.radio_button_enzyme.selected == True:
                if self.radio_button_FAp.selected == True:
                    filename = "prof_enz_weight_DP%s_FA%s_mol%s_FAp%s_p%s_-%s_+%s_e%s" % (DP, overall_FA,
                                                                                            molecules, FA_pattern,
                                                                                            pattern, minus_specificity,
                                                                                            plus_specificity, efficiency)
                    ...
                    filename = "prof_enz_weight_DP%s_FA%s_mol%s_s%s_p%s_-%s_+%s_e%s" % (DP, overall_FA,
                                                                                            molecules, strength,
                                                                                            pattern, minus_specificity,
                                                                                            plus_specificity, efficiency)
                ...
                if self.radio_button_FAp.selected == True:
                    filename = "profile_nano2_weight_DP%s_FA%s_mol%s_FAp%s_p%s_c%s" % (DP, overall_FA,
                                                                                            molecules, FA_pattern,
                                                                                            pattern, cuts)
                    ...
                    filename = "prof_nano2_weight_DP%s_FA%s_mol%s_s%s_p%s_c%s" % (DP, overall_FA,
                                                                                            molecules, strength,
                                                                                            pattern, cuts)
